...
impl BillingPlan {
    ...
    pub fn has_all_connectors(&self) -> bool { true }
    pub fn has_compliance_stack(&self) -> bool { true }

    /// Step credit pack price in USD.
    pub fn credit_pack_price_usd() -> f64 { 8.0 }
    /// Steps per credit pack.
    pub fn credit_pack_steps() -> u64 { 5_000 }
}
...
mod tests {
    ...
    #[test] fn everyone_gets_all_features() {
