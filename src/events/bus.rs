...
pub enum AgentEvent {
    // ── Preflight ──────────────────────────────────────────────────────────
    PreflightStarted { agent_id: String },
    PreflightPassed  { agent_id: String },
    PreflightFailed  { agent_id: String, reason: String },

    // ── Clarification ──────────────────────────────────────────────────────
    ClarificationNeeded  { agent_id: String, questions: Vec<String> },
    ClarificationReceived { agent_id: String },

    // ── Planning ───────────────────────────────────────────────────────────
    PlanningStarted { agent_id: String },
    PlanCreated     { agent_id: String, step_count: usize, rationale: String },

    // ── Step execution ─────────────────────────────────────────────────────
    StepStarted  { agent_id: String, step_index: usize, description: String },
    ToolCalled   { agent_id: String, step_index: usize, tool_name: String, args_preview: String },
    ToolResult   { agent_id: String, step_index: usize, tool_name: String, success: bool, output_preview: String },
    StepCompleted { agent_id: String, step_index: usize, success: bool, summary: String },
    StepRetrying  { agent_id: String, step_index: usize, delay_secs: i64, reason: String },
    ...
    // ── Delegation ─────────────────────────────────────────────────────────
    ChildSpawned     { agent_id: String, child_agent_id: String, sub_goal: String },
    ChildrenComplete { agent_id: String, child_ids: Vec<String> },

    // ── Terminal ───────────────────────────────────────────────────────────
    GoalComplete { agent_id: String, summary: String },
    GoalFailed   { agent_id: String, reason: String },
}
