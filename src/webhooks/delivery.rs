...
fn event_type_name(event: &AgentEvent) -> String {
    match event {
        ...
        AgentEvent::AgentMessageSent { .. } => "agent_message_sent",
        AgentEvent::AgentMessageReceived { .. } => "agent_message_received",
        AgentEvent::AgentMessageDelivered { .. } => "agent_message_delivered",
        AgentEvent::WorkerContinued { .. } => "worker_continued",
        ...
        AgentEvent::EvaluationComplete { .. } => "evaluation_complete",
    }
    .to_string()
}
