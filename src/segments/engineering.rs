...
pub fn plugin(deps: &SharedDeps, tenant_id: &str) -> SegmentPlugin {
    ...
    rules.rules.push(PolicyRule {
        ...
        condition: PolicyCondition::ArgsMatch { pattern: r#"(DROP|DELETE|TRUNCATE|INSERT|UPDATE).*prod"#.into() },
        action: PolicyAction::RequireApproval {
    ...
    SegmentPlugin {
        ...
        domain: DomainProfile::engineering(),
        ...
        sla_policies: vec![SlaPolicy {
            ...
            escalation_rules: vec![
                EscalationRule {
                    trigger_pct: 50.0,
                    action: EscalationAction::Notify { message: "P1 incident: 50% of SLA elapsed".into() },
                },
                EscalationRule {
                    trigger_pct: 90.0,
                    action: EscalationAction::EscalateToHuman { reason: "P1 incident approaching SLA breach".into() },
                },
            ],
        }],
    }
